...
svg.append("g").append("svg:image").attr('width', 25).attr('height', 25).attr("transform", "translate("+((0.299363122973358)*radius*0.9-12.5)+","+((-0.954139256400049)*radius*0.9-12.5)+")rotate(0)").attr("xlink:href", "img/barcelona_logo.png").on("click", function(d) {writeIntro("real_madrid")});
